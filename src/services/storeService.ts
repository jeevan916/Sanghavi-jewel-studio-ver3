  ...
  getConfig: async (): Promise<AppConfig> => {
    ...
    try {
        ...
        const sanitized = {
            ...
            whatsappGoldRateTemplateName: data?.whatsappGoldRateTemplateName || 'gold_rate_alert_daily',
            whatsappWelcomeTemplateName: data?.whatsappWelcomeTemplateName || 'welcome_subscriber',
