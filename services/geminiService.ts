  ...
  try {
    const response = await ai.models.generateContent({
      ...
      contents: {
        parts: [
          {
            text: `Professional 8k macro luxury jewelry photography of ${prompt}. Cinematic studio lighting, sharp focus on diamonds/gems, elegant metallic luster, soft depth of field, neutral gray background.`,
          },
        ],
      },
      config: {
