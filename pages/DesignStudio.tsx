...
export const DesignStudio: React.FC = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      console.error(error);
      alert("Generation failed. Please check your internet connection and prompt details.");
    } finally {
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-100">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-[10px] text-stone-400 font-medium">Model: Gemini Flash Image</span>
            </div>
          ...
          >
            ...
            {isGenerating ? 'Synthesizing...' : 'Generate Design Concept'}
          </button>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          {history.length > 0 && (
            <div className="space-y-3">
              <h4 className="text-xs font-bold text-stone-400 uppercase tracking-widest px-1">Recent Concepts</h4>
